...
test_crew_absorb_class_pause_matrix() {
  ...
  export FM_CREW_STATE_BIN="$fakebin/fm-crew-state.sh" FM_RUN_LIVENESS_BIN="$fakebin/fm-run-liveness.sh"
  ...
  export FM_FAKE_RUN_LIVENESS_RC=0
  ...
  unset FM_FAKE_CREW_STATE FM_CREW_STATE_BIN FM_RUN_LIVENESS_BIN FM_STATE_OVERRIDE
