...
FM_ACCOUNT_ROUTING_LIB_SOURCE=${BASH_SOURCE[0]}
case "$FM_ACCOUNT_ROUTING_LIB_SOURCE" in
  */*) FM_ACCOUNT_ROUTING_LIB_DIR="$(cd "${FM_ACCOUNT_ROUTING_LIB_SOURCE%/*}" && pwd)" ;;
  *) FM_ACCOUNT_ROUTING_LIB_DIR="$(pwd)" ;;
esac
unset FM_ACCOUNT_ROUTING_LIB_SOURCE
...
fm_secondmate_registry_query() {
  ...
  # shellcheck disable=SC2016 # Perl source is intentionally literal shell text.
