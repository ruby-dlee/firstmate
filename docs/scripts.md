...
The shared no-mistakes gate refusal used by mutating fleet entrypoints is summarized in [architecture.md](architecture.md#no-mistakes-gate-authority-boundary); `fm-gate-refuse-lib.sh`'s header owns its exact scope and contract.
