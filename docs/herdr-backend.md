...
Unlike poll-path triage, this native edge does not currently prove that the pause headline is non-failing or that the keyed open/resolved fold is empty before absorbing the transition.
