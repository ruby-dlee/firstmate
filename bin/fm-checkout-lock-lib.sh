...
FM_CHECKOUT_LOCK_LIB_SOURCE=${BASH_SOURCE[0]}
case "$FM_CHECKOUT_LOCK_LIB_SOURCE" in
  */*) FM_CHECKOUT_LOCK_LIB_DIR=${FM_CHECKOUT_LOCK_LIB_SOURCE%/*} ;;
  *) FM_CHECKOUT_LOCK_LIB_DIR=. ;;
esac
FM_CHECKOUT_LOCK_LIB_DIR="$(cd "$FM_CHECKOUT_LOCK_LIB_DIR" && pwd)"
