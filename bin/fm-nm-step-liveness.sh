...
#
#   liveness: <alive|dead|unknown> · run: <id> · procs: <n> · <detail>
#
...
#            A `grade:` field distinguishes unreadable evidence from processes
#            that are present without established progress. Every grade remains
#            unknown and must never be treated as healthy.
#
...
# wait. Confirmed absence is dead; established presence without progress is graded
# unknown; an unreadable observation is graded unknown. Presence alone is never
# alive. Hot-path callers that need a one-shot progress verdict use --sample 1.
