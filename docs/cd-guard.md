...
The primary firstmate shell may persist its working directory across tool calls.
...
Secondmate child crewmate and scout worktrees are likewise inert under the linked-worktree test.
