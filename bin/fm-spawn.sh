...
#   closed. Before any Azure worktree, endpoint, controller, or cloud mutation,
#   primary placement loads the private config/azure-controller.env contract
#   owned by docs/configuration.md; explicit invocation values win. Cloud
#   spawns run ENTIRELY on the pi-codex runtime: harness
