...
The routing assertion used an independently profiled, credential-safe stable-Chrome control and left the captain's existing stable process, window set, and pre-authorized read-only tab fingerprint unchanged.
...
stable_chrome_tab_set_preserved=1
