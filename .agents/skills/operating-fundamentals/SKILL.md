...
## 1. Saturate every available lane
...
## 3. Decouple validation from worker budgets
...
## 5. Obey explicit orders decisively
...
## 6. Always check before asserting
