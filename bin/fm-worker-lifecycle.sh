...
case "${1:-}" in
  request|release|resume|steer|execute|authority-receipt|service-complete|service-cancel|capacity-reserve|capacity-reserve-shape|capacity-release|capacity-retire-fence|abandon-claim|message-put|message-collect|compartment-chain-tip)
