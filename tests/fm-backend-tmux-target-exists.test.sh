...
# tmux limits Unix socket paths to roughly 104 bytes on macOS. Keep this real
# server under a bounded root instead of inheriting a long CI TMUX_TMPDIR.
SOCKET_DIR=$(mktemp -d /tmp/fm-target-exists.XXXXXX) \
