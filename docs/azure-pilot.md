...
That separate implementation may select one of the reviewed mixed-family shapes only after proving the exact family's current free quota and current retail rate.
