...
- `skill-authoring-standard` - load before authoring or substantially editing any skill in this repo or any project, and when delegating skill work to a project crew, pass `.agents/skills/skill-authoring-standard/SKILL.md` in the brief because project crewmates do not inherit this repository's section 13 or internal skills.
