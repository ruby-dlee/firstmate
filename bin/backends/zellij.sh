...
# independent review caught for the cmux backend
...
# run`. Used for the fixed spawn-time commands (the GOTMPDIR export and harness
# launch). Zellij has no single-call atomic "run and submit" action, so this
