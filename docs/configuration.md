...
FM_STALE_ESCALATE_SECS=240         # idle seconds before a positively attended stale pane escalates; unattended or unverified panes surface immediately, and a pause absorbs only without active validation
