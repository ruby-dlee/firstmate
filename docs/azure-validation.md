...
`fm/stage-c-live-acceptance` branch under the same lease coordinates, is
itself the first change validated by a cell through the full push, pull
request, and CI-green proof path.
