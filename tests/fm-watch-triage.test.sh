...
test_crew_absorb_class_classifier() {
  ...
  [ "$(crew_absorb_class a 'paused: awaiting ordered PR merges; owner=merge supervisor; clears=ordered merges complete')" = paused ] \
  ...
  [ "$(crew_absorb_class a 'paused: awaiting ordered PR merges; owner=merge supervisor; clears=ordered merges complete')" = none ] \
