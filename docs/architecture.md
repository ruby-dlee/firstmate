...
Claude Code compaction uses the tracked deterministic anchor, transcript-scoped stow completion, and compact-sourced session-start reconciliation documented in [`autocompact-recovery.md`](autocompact-recovery.md).
