...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  <id>/completion.md ship task completion report, published to the machine-global report stack before teardown
